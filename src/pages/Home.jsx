...
import { Search, Calendar, ShoppingCart, Sparkles, MessageSquare,SquareArrowOutUpRight } from 'lucide-react';
    ...
    <div className={`bg-white  text-gray-600 transition-colors duration-300`}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl italic md:text-2xl text-white mb-8 max-w-3xl mx-auto animate-fade-in-up animation-delay-150">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up animation-delay-300">
            <Link
              to="/assistant"
              className="flex px-6 py-3 bg-blue-600 text-white rounded-md text-lg font-medium hover:bg-blue-700 hover:italic transition-colors"
            >
              <SquareArrowOutUpRight className='mx-1 self-center'/>
              Try AI Assitant
            </Link>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center p-6 shadow-2xl  hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 italic">Enter the ingredients you have, and we'll suggest recipes you can make right now.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6  shadow-2xl hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 italic">Create daily, weekly, or monthly meal plans to simplify your cooking routine.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6  shadow-2xl hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 italic">Automatically generate shopping lists based on your meal plans and missing ingredients.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 shadow-2xl  hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 italic ">Get real-time cooking guidance and answers to your culinary questions.</p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl italic text-white mb-8">Join thousands of home cooks who have simplified their meal planning and discovered new favorite recipes.</p>
